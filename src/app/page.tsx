...
export default function Home() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6 space-y-8"> {/* Lighter background for the page */}
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-8">
        <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-700">Engage with our interactive math lessons designed just for you!</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-700">Strengthen your skills with our practice problems!</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-700">Learn while having fun with our educational games!</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-700">Watch your mathematics skills grow day by day!</p>
        </div>
      </div>
